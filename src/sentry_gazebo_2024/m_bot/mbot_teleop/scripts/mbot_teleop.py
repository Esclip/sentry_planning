...
if __name__=="__main__":
    ...
    pub_l = rospy.Publisher('/mbot5/left_wheel_joint_controller/command', Float64, queue_size=1)
    pub_r = rospy.Publisher('/mbot5/right_wheel_joint_controller/command', Float64, queue_size=1)
